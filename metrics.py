...
class Metrics:
    def __init__(self):
        ...
        self.c.execute('''CREATE TABLE IF NOT EXISTS fnc_exec
                         (function_name TEXT, execution_time REAL, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP)''')
    ...
    def track_fnc_exec(self, func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            self.c.execute("INSERT INTO fnc_exec (function_name, execution_time) VALUES (?, ?)",
    ...
    def fetch_fnc_exec(self):
        self.c.execute('''SELECT function_name, COUNT(1) as nb_exec,
                          AVG(execution_time) as mean_exec_time,
                          MAX(execution_time) as max_exec_time, MIN(execution_time) as min_exec_time
                          FROM fnc_exec
